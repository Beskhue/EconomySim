...
public class Simulator implements ConfigurationSerializable
{
    ...
    /**
     * Get the total price of an array of item stacks for a given transaction
     * type and a given world group.
     * 
     ...
     */
    public double getTotalPrice(String worldGroup, ItemStack[] items,
        ...
        double buyPriceAsymptote, double sellPriceFactor, double buyPriceFactor)
    {
        ...
        {   // Demand crosses the vertical axis
            price = 
